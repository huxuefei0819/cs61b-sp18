...
public class MergeSort {
    ...
    public static <Item extends Comparable> Queue<Item> mergeSort(
        ...
        while (sourceQueues.size() > 1) {
            ...
            sourceQueues.enqueue(mergeSortedQueues(q1, q2));
        }
        return sourceQueues.dequeue();
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Before merge sort, original student: " + students);
        Queue<String> sortedStudents = MergeSort.mergeSort(students);
        System.out.println("After merge sort, original student: " + students);
        System.out.println("After merge sort, sorted student: " + sortedStudents);
    }
